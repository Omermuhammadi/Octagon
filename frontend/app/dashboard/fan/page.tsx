    ...
    const stats = useMemo(() => {
        ...
        return [
            { 
                ...
                value: user.predictionsMade?.toString() || "0", 
                icon: Target
            },
            { 
                label: "Accuracy Rate", 
            ...
            { 
                ...
                value: user.trainingSessions?.toString() || "0", 
                icon: Trophy
            },
            { 
                label: "Days Active", 
                value: user.daysActive?.toString() || "0", 
                icon: Calendar
            }
        ];
    }, [user]);
                        ...
                        <Card variant="glass" className="p-6 sm:p-8">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="p-3 bg-white/5 rounded-lg border border-white/10 text-center">
                                    <div className="text-2xl font-display text-octagon-red">{user.accuracyRate || 0}%</div>
                                    <div className="text-xs text-gray-400">Accuracy</div>
                                </div>
                                <div className="p-3 bg-white/5 rounded-lg border border-white/10 text-center">
                                    <div className="text-2xl font-display text-octagon-red">{user.predictionsMade || 0}</div>
